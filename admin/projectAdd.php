            ...
            <div id="content">
               ...
               <div class="container mt-5">
                <form action="process.php" method="POST" enctype="multipart/form-data" >
                     ...
                     <div class="mb-3">
                        <label for="Site Başlığı" class="form-label">Proje Resmi</label>
                     ...
                     <div class="mb-3">
                        <label for="Site Anahtar Kelime" class="form-label">Proje Sırası</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1"  name="sira" >
                     </div>

                     
                     <button class="mb-3 btn btn-success btn-lg" name="projeAdd">Kaydet</button>
                     </div>
            </form>

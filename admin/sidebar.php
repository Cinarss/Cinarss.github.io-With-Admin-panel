...
<nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="info.php"><i class="fa fa-diamond blue_color"></i> <span>İnformation Header</span></a></li>
                     <li><a href="project.php"><i class="fa fa-table purple_color2"></i> <span>Project</span></a></li>
